...
export default function EpisodesProfile(props) {
        ...
        .then((querySnapshot) => {
          querySnapshot.forEach((doc) => {
            if (
              ...
              //   let test = parseInt(props.season_number + 1)
              // if (props.season_number <= parseInt(props.show_all_seasons)) {
              // TODO: WATCH OUT THIS FOR NEW SEASON OF RETURNING SERIES
              if (
  ...
  //   console.log(props.curr_season_episodes)
  //   console.log(props.air_date)
  //   console.log(props.today)
  //   console.log(props.show_all_seasons)
  //   console.log(props.season_number + 1)
  // console.log("db", userWatchingTime)
  // console.log("api", props.episode_time[0])
  // console.log(userTotalEpisodes)

  // if (props.showName === "The Handmaid's Tale") {
  //   console.log("CURRENT SEASON NUMBER", props.season_number, props.showName)
  //   console.log(
  //     "ALL SHOW SEASONS",
  //     parseInt(props.show_all_seasons),
  //     props.showName
  //   )
  //   console.log("DAYS UNTIL EPISODE", props.daysUntilCurrentEpisode)
  // }
  ...
  function goToShow(showID) {
    ...
    fetch(
      ...
      //  fetch(`https://api.themoviedb.org/3/tv/${showID}/external_ids?api_key=***REMOVED***&language=en-US`)
  ...
  // console.log(props.show_status === "Returning Series")
